...
public sealed partial class AddBuffDefine : Luban.BeanBase
{
    public AddBuffDefine(JToken _buf) 
    {
    ...
    public static AddBuffDefine DeserializeAddBuffDefine(JToken _buf)
    {
        return new AddBuffDefine(_buf);
    }
    ...
    public const int __ID__ = 1769028431;
