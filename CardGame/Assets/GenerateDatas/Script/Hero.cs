...
public sealed partial class Hero : Luban.BeanBase
{
    public Hero(JToken _buf) 
    {
        ...
        { var __json0 = _obj.GetValue("SkillIds"); int _n0 = (__json0 as JArray).Count; SkillIds = new int[_n0]; int __index0=0; foreach(JToken __e0 in __json0) { int __v0;  __v0 = (int)__e0;  SkillIds[__index0++] = __v0; }   }
    }
