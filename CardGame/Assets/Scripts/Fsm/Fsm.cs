    ...
    internal sealed class Fsm<T> : FsmBase, IReference, IFsm<T> where T : class
    {
        ...
        public static Fsm<T> Create(string name, T owner, params FsmState<T>[] states)
        {
            ...
            foreach (FsmState<T> state in states)
            {
                ...
                {
                    throw new Exception($"FSM '{new TypeNamePair(typeof(T), name).ToString()}' state '{stateType}' is already exist.");
                }
        ...
        public void Start<TState>() where TState : FsmState<T>
        {
            ...
            if (state == null)
            {
                throw new Exception($"FSM '{new TypeNamePair(typeof(T), Name).ToString()}' can not start state '{typeof(TState).FullName}' which is not exist.");
            }
        ...
        public void Start(Type stateType)
        {
            ...
            if (state == null)
            {
                throw new Exception($"FSM '{new TypeNamePair(typeof(T), Name).ToString()}' can not start state '{stateType.FullName}' which is not exist.");
            }
        ...
        internal void ChangeState(Type stateType)
        {
            ...
            if (state == null)
            {
                throw new Exception($"FSM '{new TypeNamePair(typeof(T), Name).ToString()}' can not change state to '{stateType.FullName}' which is not exist.");
            }
