...
namespace MyGame
{
    public sealed partial class ObjectPoolManager : IPreGameService, IObjectPoolManager
    {
        /// <summary>
        /// 对象池。
        /// </summary>
        ...
        {
            private readonly SelfMultiDictionary<string, Object<T>> m_Objects;
            ...
            public ObjectPool(string name, bool allowMultiSpawn, float autoReleaseInterval, int capacity, float expireTime, int priority)
                : base(name)
            {
                m_Objects = new SelfMultiDictionary<string, Object<T>>();
            ...
            public bool CanSpawn(string name)
            {
                ...
                SelfLinkedListRange<Object<T>> objectRange = default(SelfLinkedListRange<Object<T>>);
            ...
            public void Unspawn(object target)
            {
                ...
                {
                    throw new Exception($"Can not find target in object pool '{new TypeNamePair(typeof(T), Name).ToString()}', target type is '{target.GetType().FullName}', target value is '{target.ToString()}'.");
                }
            }
            ...
            public override ObjectInfo[] GetAllObjectInfos()
            {
                ...
                foreach (KeyValuePair<string, SelfLinkedListRange<Object<T>>> objectRanges in m_Objects)
                {
