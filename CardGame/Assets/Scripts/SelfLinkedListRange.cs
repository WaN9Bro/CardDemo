...
namespace MyGame
{
    ...
    public struct SelfLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public SelfLinkedListRange(LinkedListNode<T> first, LinkedListNode<T> terminal)
        {
        ...
        {
            private readonly SelfLinkedListRange<T> _mSelfLinkedListRange;
            private LinkedListNode<T> m_Current;
            private T m_CurrentValue;

            internal Enumerator(SelfLinkedListRange<T> range)
            {
                if (!range.IsValid)
                {
                    throw new Exception("Range is invalid.");
                ...
                _mSelfLinkedListRange = range;
                m_Current = _mSelfLinkedListRange.m_First;
            ...
            {
                if (m_Current == null || m_Current == _mSelfLinkedListRange.m_Terminal)
                {
                    return false;
                }
