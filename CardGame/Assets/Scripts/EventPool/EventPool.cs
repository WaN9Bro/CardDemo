...
namespace MyGame
{
    ...
    {
        private readonly SelfMultiDictionary<int, EventHandler<T>> m_EventHandlers;
        ...
        public EventPool()
        {
            m_EventHandlers = new SelfMultiDictionary<int, EventHandler<T>>();
        ...
        {
            SelfLinkedListRange<EventHandler<T>> range = default(SelfLinkedListRange<EventHandler<T>>);
